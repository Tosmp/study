...
def DualResNet_imagenet(pretrained=False, augment=False):
    model = DualResNet(BasicBlock, [2, 2, 2, 2], num_classes=19, planes=32, spp_planes=128, head_planes=64, augment=augment)
    if pretrained:
        checkpoint = torch.load('/home/sugimoto/weights/ddr/' + "DDRNet23s_imagenet.pth", map_location='cpu') 
        '''      
...
def get_seg_model(cfg, **kwargs):
    ...
    model = DualResNet_imagenet(pretrained=False, **kwargs)
    return model
